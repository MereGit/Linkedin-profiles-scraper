...
def is_correct_role_ai(linkedin_url: str, expected_role: str, firm: str) -> bool, str:
	...
	# Search for exact URL to get snippet
	    ...
	    for result in results:
	    	if is_linkedin_profile_url(result.get('link', '')) == True:
		        ...
		        if check == "TRUE":
		            return True, "Perfect match"
		     		...
		     		return True, "Matching role, missing firm"
		     	elif check == "WRONG_ROLE": 
		     		return True, "Wrong role, matching firm"
